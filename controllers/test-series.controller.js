...
exports.getAllTestSeries = async (req, res) => {
  try {
    console.log("fetchingtestSeries")
...
exports.getTestSeriesForProduct = async (req, res) => {
  try {
    const allTestSeries = await TestSeries.find({ productMade: false }).populate({
      path: "testSeriesCreatedBy", // Field in TestSeries schema referencing User
